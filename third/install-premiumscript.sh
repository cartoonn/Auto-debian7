...
chmod +x /usr/local/bin/ล้อคผู้ใช้ที่หมดอายุ
...
chmod +x /usr/local/bin/เปลี่ยนรหัสผ่าน
...
chmod +x /usr/local/bin/บัญชีที่ออนไลน์-pptp
...
chmod +x /usr/local/bin/เทสควาวเร็วเน็ต
