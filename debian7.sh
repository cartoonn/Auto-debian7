...
if [ "$scriptchecker" != "" ]; then
		clear
		echo -e " ";
		echo -e "ข้อผิดพลาด! คุณได้ป้อนสคริปต์นี้มาแล้ว";
		echo -e "สคริปต์นี้ควรแทรกเพียง 1x เท่านั้น!";
		echo -e "---";
		echo -e "ถ้าก่อนหน้านี้คุณล้มเหลวในการติดตั้งกรุณาติดตั้ง VPS OS ของคุณก่อน!";
		echo -e "คุณสามารถติดตั้ง VPS OS ผ่านแผงควบคุม VPS ได้";
		echo -e "วิธีเข้าถึงแผงควบคุม VPS: THIRD-VPN";
		echo -e " ";
        exit 0;
	else
		echo "";
...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://github.com/cartoonn/Auto-debian7/raw/master/third/screenfetch"
...
wget -O /home/vps/public_html/index.html "https://github.com/cartoonn/Auto-debian7/raw/master/third/index.html"
...
# OpenVPN Configuration Dibuat Oleh THIRD-VPN
# (Official Partner THIRD-VPN)
client
proto tcp
persist-key
persist-tun
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://github.com/cartoonn/Auto-debian7/raw/master/third/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://github.com/cartoonn/Auto-debian7/raw/master/third/badvpn-udpgw64"
fi
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://github.com/cartoonn/Auto-debian7/raw/master/third/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://github.com/cartoonn/Auto-debian7/raw/master/third/mrtg-mem.sh"
...
curl "https://github.com/cartoonn/Auto-debian7/raw/master/third/mrtg.conf" >> /etc/mrtg.cfg
...
wget https://github.com/cartoonn/Auto-debian7/raw/master/repo/dropbear/dropbear-2016.74.tar.bz2
...
# install vnstat gui
cd /home/vps/public_html/
wget https://github.com/cartoonn/Auto-debian7/raw/master/repo/vnstat_php_frontend-1.5.1.tar.gz
...
# install webmin
cd
wget "https://github.com/cartoonn/Auto-debian7/raw/master/third/webmin_1.801_all.deb"
...
# download script
cd
wget https://github.com/cartoonn/Auto-debian7/raw/master/third/install-premiumscript.sh -O - -o /dev/null|sh
...
echo ""  | tee -a log-install.txt
echo "ข้อมูลแอพพลิเคชันและพอร์ต"  | tee -a log-install.txt
...
echo ""  | tee -a log-install.txt
echo "เครื่องมือข้อมูลในเซิร์ฟเวอร์"  | tee -a log-install.txt
...
echo ""  | tee -a log-install.txt
echo "ข้อมูลสำคัญ"  | tee -a log-install.txt
echo "   - ดาวน์โหลด Config OpenVPN : http://$MYIP:85/client.ovpn"  | tee -a log-install.txt
...
echo "     NB: ผู้ใช้และรหัสผ่าน Webmin เหมือนกับรหัสผู้ใช้และรหัสผ่าน root"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "----------- Modified by THIRD-VPN ------------"
